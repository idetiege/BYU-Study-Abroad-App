...
export const emergencyContacts = [
  { label: 'US Embassy Italy', phone: '+39 06 46741' },
  { label: 'US Embassy Slovenia', phone: '+386 1 200 5500' },
  { label: 'US Embassy Croatia', phone: '+385 1 661 2200' },
  { label: 'US Embassy Bosnia', phone: '+387 33 704 000' },
  { label: 'US Embassy Montenegro', phone: '+382 20 410 500' },
  { label: 'US Embassy Albania', phone: '+355 4 224 7285' },
  { label: 'US Embassy Greece', phone: '+30 210 720 2490' },
  { label: 'Trip Leader — Isaac', phone: 'TBD' },
];
...
export const phrasebook = [
  ...
  },
  {
    ...
    phrases: [
      ...
      { phrase: 'Prosim', english: 'Please', phonetic: 'PROH-seem', category: 'Greetings' },
    ],
  },
  {
    lang: 'Croatian', langCode: 'hr-HR', flag: '🇭🇷', country: 'Croatia', days: [10, 11, 12],
    phrases: [
  ...
  {
    lang: 'Bosnian', langCode: 'bs-BA', flag: '🇧🇦', country: 'Bosnia', days: [13, 14, 15],
    phrases: [
      { phrase: 'Merhaba', english: 'Hello', phonetic: 'mehr-HAH-bah', category: 'Greetings' },
      { phrase: 'Hvala', english: 'Thank you', phonetic: 'HVAH-lah', category: 'Greetings' },
  ...
  },
  {
    ...
    phrases: [
      ...
      { phrase: 'Parakaló', english: 'Please', phonetic: 'pah-rah-kah-LOH', category: 'Greetings' },
