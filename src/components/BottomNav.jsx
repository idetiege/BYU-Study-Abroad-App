...
function HomeIcon({ active }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill={active ? '#E9B753' : 'none'} stroke={active ? '#E9B753' : '#D2AF7D'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function CalendarIcon({ active }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={active ? '#E9B753' : '#D2AF7D'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] z-50"
         style={{ background: '#073C77', backdropFilter: 'blur(16px)', borderTop: '1px solid rgba(233,183,83,0.15)', paddingBottom: 'env(safe-area-inset-bottom)' }}>
      <div className="flex">
          ...
          >
            {({ isActive }) => (
              <>
                ...
                <span style={{ fontSize: '10px', fontWeight: 600, color: isActive ? '#E9B753' : '#D2AF7D', letterSpacing: '0.5px', textTransform: 'uppercase' }}>
                  {label}
                </span>
              </>
            )}
