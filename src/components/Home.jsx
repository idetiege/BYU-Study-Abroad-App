...
import {
  TRIP_START, TOTAL_DAYS, FUN_FACTS,
...
export default function Home() {
  ...
  return (
    <div className="overflow-y-auto h-full" style={{ paddingBottom: 'calc(4rem + env(safe-area-inset-bottom))' }}>
      {/* Hero */}
      {dayData && (
        <HeroImage
      ...
      {/* Weather + Clock — reads timezone directly from day data */}
